...
class CSampleRdkMaterialAutoUIRdkPlugIn : public CRhRdkRenderPlugIn
{
public:
	...
	//virtual void UiContentTypes(ON_SimpleArray<UUID>& aTypesOut) const override;
...
//
	...
	// Preview renderers.
	//virtual bool CreatePreview(const CSize& sizeImage, RhRdkPreviewQuality quality, const IRhRdkPreviewSceneServer* pSceneServer, IRhRdkPreviewCallbacks* pNotify, CRhinoDib& dibOut) override;
